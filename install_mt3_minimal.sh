...
echo "🚀 Minimal MT3 Installation Script"
echo "=================================="
...
echo ""
echo "🐍 Step 2: Checking current Python setup..."
echo "Current python3 version: $(python3 --version)"
echo "Current pip version: $(pip3 --version 2>/dev/null || echo 'pip3 not found')"
...
echo ""
echo "📁 Step 5: Setting up MT3 project..."
